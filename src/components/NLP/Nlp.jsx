      ...
      <div className="article">
        <div className=" article space-y-2 mx-auto flex flex-col justify-center">
          <div
            ...
            style={{ backgroundImage: `url(${"https://aiproff.ai/dist/assets/nlp-654b1bf74208d-354830eb.png"})` }}
          >
            <img
              ref={imageRef}
              src="https://aiproff.ai/dist/assets/nlp-654b1bf74208d-354830eb.png"
              alt="Generative AI"
            ...
            <div className=" mt-12 text-lg md:text-xl font-light leading-normal space-y-6 md:flex justify-center">
              <div className="flex-grow md:w-4/6 space-y-20 justify-center">
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    <img src="https://aiproff.ai/dist/assets/nlp_img2-13e7c0f1.jpg" alt="graph-economic-impact" />
                    <p className="text-xs ">
                ...
                <div>
                  <img src="https://aiproff.ai/dist/assets/nlp_img3-d0311039.jpg" alt="graph-economic-impact" />
                  {/* <p className="text-xs ">
                ...
                <div>
                  ...
                  <img src="https://aiproff.ai/dist/assets/nlp_img4-d191169b.jpg" alt="" className="mb-5" />
                  <p>
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    <img src="https://aiproff.ai/dist/assets/nlp_img5-7da65d1d.jpg"></img>
                    <p className="text-xs ">
